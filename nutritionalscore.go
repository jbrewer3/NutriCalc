...
var fiberLevels = []float64{4.7, 3.7, 2.8, 1.9, .9}
var protienLevels = []float64{8.0, 6.4, 4.8, 3.2, 1.6}

var energyLevelsBeverage = []float64{270, 240, 210, 180, 150, 120, 90, 60, 30, 0}
var sugareLevelsBeverage = []float64{13.5, 12, 10.5, 9, 7.5, 6, 4.5, 3, 1.5, 0}
...
func (s SugarGram) GetPoints(st ScoreType) int{
	if st == Beverage{
		return getPointsFromRange(float64(s), sugareLevelsBeverage)
	}
...
// get an alphabetical value for our food
